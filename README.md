...
| `pages`    | MDX              | Composed marketing pages (e.g. team, guides index) |
...
├── src/
│   ├── components/         # UI components (landing, mdx, and shared)
