...
export const themes: Record<AccentName, ThemeTokens> = {
  Coral: { accent: '#ff6a3d', accentInk: '#c63f1b', accentSoft: '#ffe1d3', accentDeep: '#7a2e17' },
  Grape: { accent: '#7c5cff', accentInk: '#5b3fd6', accentSoft: '#e9e2ff', accentDeep: '#38257a' },
  Forest: { accent: '#2fa36b', accentInk: '#1e7a4e', accentSoft: '#d7f0e2', accentDeep: '#154d32' },
  Ocean: { accent: '#2b8ae0', accentInk: '#1c6bb8', accentSoft: '#d8ebfa', accentDeep: '#124066' },
};
